...
import com.example.sellers.model.NotiSendData;
import com.example.sellers.retrofit.ApiPushNotification;
import com.example.sellers.retrofit.ApiShopee;
import com.example.sellers.retrofit.RetrofitClient;
import com.example.sellers.retrofit.RetrofitClientNoti;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    private void pushNotication() {
        String token = "ez2LDLtDTSaNaBU8nM5aUS:APA91bF2InAEBLf_zH_m9JQ39YAp0HB2FIu73kBd139Pl22Ke61_8DTS987N-_zm3ypESdq6Krddo4yITsWv02Jqe7y64ChlGhvsENMDeTZMYUDkh3CyQAju7H5p-boz5r4Sw_t_Duoy";
        ...
        compositeDisposable.add(apiPushNotification.sendNotification(notiSendData)
                ...
                .subscribe(
                        notiResponse -> {
                            Toast.makeText(getApplicationContext(), "Đã gửi thông báo", Toast.LENGTH_SHORT).show();
                        },
                        throwable -> {
